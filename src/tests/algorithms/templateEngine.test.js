import Templater from "../../algorithms/templateEngine";
...
describe("Templater", () => {
  ...
  it("supports nesting, chaining", () => {
    ...
    expect(
      Templater()
        .p({ id: "header", class: "awesome" }, Templater().span("nested", { id: "header", class: "awesome" }), Templater().span("span"))
        .toString()
        ).toBe('<p class="awesome" id="header"><span class="awesome" id="header">nested</span><span>span</span></p>');
    expect(() => {
